...
type Booking = {
  ...
  status: string; paymentMethod: string; customerName: string; assignment: { driverId: string } | null;
};
...
export function NotionCalendar({ serviceType }: { serviceType: "transfer" | "hourly" | "tour" }) {
