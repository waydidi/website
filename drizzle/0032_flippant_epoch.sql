...
-- First code, as a draft: edit and activate them in Admin → Promotions.
--> statement-breakpoint
INSERT INTO `promo_codes` (`id`,`code`,`title`,`discount_type`,`discount_value`,`max_discount`,`min_fare`,`starts_at`,`ends_at`,`max_uses`,`per_customer_limit`,`first_booking_only`,`service`,`vehicles_json`,`offer_terms_json`,`show_on_homepage`,`status`,`created_at`,`updated_at`) VALUES ('promo_newuser20','NEWUSER20','[New Users] 20% off your first Waydidi ride','percent',20,NULL,0,NULL,NULL,NULL,1,1,'any',NULL,'["Discount 20% on your first Waydidi booking.", "Valid for your first Waydidi booking only (per email, phone and account)."]',1,'draft','2026-09-24T00:00:00.000Z','2026-09-24T00:00:00.000Z');
