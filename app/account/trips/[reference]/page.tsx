  ...
  return <AccountShell name={customer.name} email={customer.email}>
    ...
    <div className="mt-6 grid gap-5 lg:grid-cols-[1fr_300px]">
      ...
      <aside className="grid content-start gap-5">
        ...
        <p className="px-1 text-sm leading-6 text-slate-500">Changes and cancellations follow the <Link href="/cancellation-refund-policy" className="font-bold text-[#C96100] hover:underline">cancellation policy</Link>. Meeting instructions and your trip PIN are in your confirmation email.</p>
      </aside>
    </div>
  </AccountShell>;
}
