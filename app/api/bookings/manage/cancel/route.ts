...
export async function POST(request:Request){
  ...
  if(active.some(a=>["going_to_standby","standby","passenger_verified","trip_started","passenger_picked_up","completed","no_show"].includes(a.currentStatus)))return NextResponse.json({error:"Your driver has started this journey. Contact Waydidi support."},{status:409});
